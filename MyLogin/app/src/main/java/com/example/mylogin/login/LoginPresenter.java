...
import com.example.mylogin.base.BasePresenter;
import com.example.mylogin.data.DataManager;
import com.example.mylogin.data.EmailModel;
...
public class LoginPresenter<V extends LoginMvpView> extends BasePresenter<V> implements LoginMvpPresenter<V> {
    ...
    public void validate(String emailId, String password) {
        if (!EmailModel.isEmailValid(emailId) || !EmailModel.isPasswordValid(password))
            getMvpView().refresh();
        else {
